from pas.plugins.spidcie.testing import FUNCTIONAL_TESTING
from pas.plugins.spidcie.testing import INTEGRATION_TESTING
from pas.plugins.spidcie.testing import RESTAPI_TESTING
